...
import Toggle from 'react-toggle'; // TODO: build my own...
    ...
    return (
      ...
      >
        <Toggle
          ...
          icons={{ checked: <Night />, unchecked: <Day /> }}
        />
        <div
          className='copyright'
        >
...
const Night: React.SFC<any> = (props: any) => {
  return (
    <img
...
const Day: React.SFC<any> = (props: any) => {
  return (
